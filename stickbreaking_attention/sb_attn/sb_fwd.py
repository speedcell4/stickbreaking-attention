...
def _forward(
    ...
    O_ptr, stride_ob, stride_oh, stride_om: tl.constexpr, stride_od: tl.constexpr,
    R_ptr, stride_rb, stride_rh, stride_rm: tl.constexpr,
    A_ptr, stride_ab, stride_ah, stride_am: tl.constexpr,
    W_ptr, stride_wb, stride_wh, stride_wm, stride_wn,
    ...
    seq_num_progs = tl.num_programs(2)
...
def _fwd(q, k, v, logit_scale,
         no_grad=False, return_attention=False, BLOCK_M: int=64, BLOCK_N: int=32):
    ...
    _forward[grid](
        ...
        rem, rem.stride(0), rem.stride(1), rem.stride(2),
        neg_log_acc, neg_log_acc.stride(0), neg_log_acc.stride(1), neg_log_acc.stride(2),
        W, W.stride(0), W.stride(1), W.stride(2), W.stride(3),
